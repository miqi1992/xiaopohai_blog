...
alter table project_config_attachment_info add `order_type` int(2) NOT NULL DEFAULT '1' COMMENT '订单类型：1-服务单；2-变更单';
```
...
2. 查询：/queryDetailConfig/dealinfo   改为Post，增加orderType
### 处理信息
	1. 新增: threeproject/addRecordInfo   增加orderType
	2. 查询： 、